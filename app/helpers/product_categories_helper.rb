module ProductCategoriesHelper
  def category_tooltip_link(content, path, tooltip_id, tooltip_content)
    link_to content.truncate(70), path,
            data: { tooltip_target: tooltip_id, tooltip_placement: "top", turbo_frame: "_top" }
  end

  def category_tooltip_content(tooltip_id, tooltip_content)
